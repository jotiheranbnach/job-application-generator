...
class DIN_5008_2011_04_form_B {
    ...
    writeJobApplication() {
        PDF_1.PDF.generate(() => {
            // Empfänger
            this.document.rect(PDF_1.PDF.m2p(20), PDF_1.PDF.m2p(45), PDF_1.PDF.m2p(85), PDF_1.PDF.m2p(40 + 5)).stroke('black');
            // Absender
            this.document.rect(PDF_1.PDF.m2p(125), PDF_1.PDF.m2p(50), PDF_1.PDF.m2p(75), PDF_1.PDF.m2p(40)).stroke('black');
            // Inhalt
            this.document.rect(PDF_1.PDF.m2p(25), PDF_1.PDF.m2p(50 + 40 + 8.46), PDF_1.PDF.m2p(210 - 25 - 20), PDF_1.PDF.m2p(178)).stroke();
            // Faltmarke 1
            this.document.moveTo(PDF_1.PDF.m2p(0), PDF_1.PDF.m2p(105))
                .lineTo(PDF_1.PDF.m2p(10), PDF_1.PDF.m2p(105))
                .stroke('lightgray');
            // Faltmarke 2
            this.document.moveTo(PDF_1.PDF.m2p(0), PDF_1.PDF.m2p(105 + 105))
                .lineTo(PDF_1.PDF.m2p(10), PDF_1.PDF.m2p(105 + 105))
                .stroke('lightgray');
            // Faltmarke 1
...
exports.DIN_5008_2011_04_form_B = DIN_5008_2011_04_form_B;
